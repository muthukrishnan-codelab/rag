...
export default function UploadModal() {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {open && (
          // Increased z-index to 9999 to break out of parent stacking contexts
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
            
            {/* Backdrop: Increased opacity for better separation */}
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            ...
            >
              ...
              <div className="space-y-5">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  ...
                  <button className="flex-[2] py-4 bg-slate-900 text-white rounded-2xl font-bold shadow-xl shadow-slate-200 hover:bg-indigo-600 transition-all active:scale-95 order-1 sm:order-2">
                    Confirm Upload
                  </button>
                </div>
              </div>
